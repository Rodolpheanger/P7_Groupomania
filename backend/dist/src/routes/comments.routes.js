...
router.post("/new/:id", auth_middleware_1.default, comments_controllers_1.createComment);
router.get("/:id", auth_middleware_1.default, comments_controllers_1.getCommentsByPost);
router.put("/:id", auth_middleware_1.default, comments_controllers_1.modifyComment);
