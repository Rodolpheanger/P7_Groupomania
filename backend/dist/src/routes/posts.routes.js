...
router.post("/new", auth_middleware_1.default, multer_middleware_1.uploadPostImage, post_validation_middleware_1.postValidation, posts_controllers_1.createPost);
router.get("/posts", auth_middleware_1.default, posts_controllers_1.getAllPosts);
router.get("/author", auth_middleware_1.default, post_validation_middleware_1.postValidation, posts_controllers_1.getPostsByAuthor);
